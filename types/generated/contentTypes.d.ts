...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    deliverySize: Schema.Attribute.Enumeration<
      ['small', 'midium', 'large', 'oversize', 'n/a']
    >;
    email: Schema.Attribute.String;
    emailSent: Schema.Attribute.Component<'elements.is-email-sent', false>;
    fulfillmentStatus: Schema.Attribute.Enumeration<
      ['processing', 'confirmed', 'ready', 'completed', 'cancelled', 'rejected']
    >;
    ...
    shippingOption: Schema.Attribute.Component<
  ...
  attributes: {
    ...
    sections: Schema.Attribute.DynamicZone<
      [
        ...
        'form.newsletter',
        'form.inquiry',
        'sections.category-button-section',
        'sections.store-feature-grid',
...
export interface ApiPaymentPayment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cardDetails: Schema.Attribute.Component<'elements.card', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    orderId: Schema.Attribute.Relation<'manyToOne', 'api::order.order'>;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    maxQuantityForLargeShipment: Schema.Attribute.Integer;
...
export interface ApiWarehouseWarehouse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    odoo_warehouse_id: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String &
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    business_type: Schema.Attribute.Enumeration<['INSTALLER', 'RETAILER']>;
    ...
    isRegisteredForNews: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
    ...
    user_level: Schema.Attribute.Enumeration<
      ['DEFAULT', 'SMALL', 'MID_SIZE', 'VIP', 'WHOLE_SELLER']
    >;
    username: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
